...
module.exports = async function(args){
    ...
    let numToPrint = args.numToPrint;
    ...
    //Assuming 30 barcodes per page
    // const barcodesPerPage = 30;
    // let numPages = Math.ceil(numToPrint / barcodesPerPage);

    // await makePDF(barcode, numPages);
    await makePDF(barcode, numToPrint);
