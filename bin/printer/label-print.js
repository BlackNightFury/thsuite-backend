...
^FB500,11,0,L,0
^FD
There may be health risks associated with the consumption of this product. This marijuana’s potency was tested with an allowable plus or minus 15% variance pursuant to 12-43.4-202(3)(a)(IV)(E), C.R.S. There may be additional health risks associated with the consumption of this product for women who are pregnant, breast feeding, or planning on becoming pregnant. Do not drive or operate heavy machinery while using marijuana. The marijuana contained within this package complies with the  mandatory contaminant testing required by rule R 1501.
^FS
...
^FB150,14,0,L,0
^FD
Ingredients: Aloe vera, alfalfa, barley, basalt, coconut water, comfrey, compost, crustacean meal, earthwork castings, fish meal, gypsum, Karanja, kelp, molasses. micro nutrients: boron cobalt copper, fluvic acid, humic acid, iron, manganeses, molybdenum, neem, sulfur, yarrow
^FS
...
^FB250,2,0,L,0
^FD
METRC TAG \\& 1A400031266F14F000000292
^FS
...
^XZ
    ...
    printer.printDirect({
        data: buffer,
        printer: "ZDesigner TLP 2824 Plus (ZPL)",
        type: 'RAW',
